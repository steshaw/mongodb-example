--
-- Example code from
-- https://hackage.haskell.org/package/mongoDB-2.1.1/docs/Database-MongoDB.html
--
...
run = do
   ...
   newYorkCityTeams >>= printDocs "New York City Teams"
...
newYorkCityTeams = rest =<< find (select ["home.state" =: "NY", "home.city" =: "New York"] "team")
